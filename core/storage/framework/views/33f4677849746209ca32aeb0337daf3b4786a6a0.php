                        ...
                        <div class="right-content d-flex align-items-center">
                            <a href="javascript:void(0);" class="item-bookmark icon-2 mt-2">
                                <img src="<?php echo e(url('')); ?>/assets/assets/images/wallet.svg" alt="wallet-image" width="30"
                                     height="30">
                                <span
                                    class="text-muted text-bold"><?php echo e(number_format(Auth::user()->balance ?? 0, 2)); ?></span><br>
                            </a>
                        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/logsnew/core/resources/views/templates/basic/layouts/nofooter.blade.php ENDPATH**/ ?>