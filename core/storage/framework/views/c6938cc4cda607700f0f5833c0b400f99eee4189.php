    ...
    <?php if(session()->has('order')): ?>
        <div class="alert alert-success">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Item purchased successfully!</strong><a href="<?php echo e($url_data); ?>"> CLICK HERE TO VIEW YOUR
                    ORDER 👉🏽
                    DOWNLOAD.</a>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-start col-lg-12  col-sm-12 p-3 my-3 text-black-50">
                ...
                <div class="lh-100">
                    ...
                    <small>NGN <?php echo e(number_format($spent, 2)); ?></small>
                </div>
            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/logsnew/core/resources/views/templates/basic/user/profile.blade.php ENDPATH**/ ?>