        ...
        <div class="card custom--card">
            ...
            <div class="card-body p-5">
                ...
                <div class="footer fixed">
                    ...
                    <div class="container">
                        <a href="<?php echo e($data->url); ?>"  style="border: 0px; background: linear-gradient(279deg, #FF0B9E -6.58%, #FF6501 121.69%); color: white;"   class="btn btn-primary text-start w-100 btn-rounded">
...
<?php echo $__env->make($activeTemplate.'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/logsnew/core/resources/views/templates/basic/user/payment/Enkpay.blade.php ENDPATH**/ ?>