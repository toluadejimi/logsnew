        ...
        <div class="row gy-4">
            ...
            <div class="col-xl-12 col-sm-12">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <p>Invite your friends to buy on Log Marketplace and make money when they Buy our Products! T&Cs
                        apply</p>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form action="/user/send-funds" method="POST">
                                        ...
                                        <button
                                            ...
                                            class="btn text-white w-100 my-2 mt-2" type="submit">
                                            Cash Out
                                        </button>
...
<?php echo $__env->make($activeTemplate.'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/logsnew/core/resources/views/templates/basic/user/referal.blade.php ENDPATH**/ ?>