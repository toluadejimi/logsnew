...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container" style="padding-bottom: 350px">
        ...
        <div class="col-lg-12">
            ...
            <div style="border-radius: 10px; padding: 10px; margin-bottom: 10px; background: #10113D;color: #ffffff; font-size: 11px">
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <button style="border: 0px" class="copy-button form-control"
                                        onclick="copyToClipboard<?php echo e($id); ?>()">
...
<?php echo $__env->make($activeTemplate . 'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/logsnew/core/resources/views/templates/basic/user/order_details.blade.php ENDPATH**/ ?>