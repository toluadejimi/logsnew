        ...
        <div class="card custom--card">
            ...
            <div class="card-body p-5">
                ...
                <div class="footer fixed">
                    ...
                    <div class="container">
                        <a href="{{ $data->url }}"  style="border: 0px; background: linear-gradient(279deg, #FF0B9E -6.58%, #FF6501 121.69%); color: white;"   class="btn btn-primary text-start w-100 btn-rounded">
