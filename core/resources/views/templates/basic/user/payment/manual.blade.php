                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="input-container mr-4 text-center">
                                    ...
                                    <input id="copy"  style="border: 0; text-align: left; font-size: 18px;" value="@php echo  $data->gateway->acct_no @endphp" class="input-field text-bold" type="text">
                                ...
                                <h2 style="font-size: 16px">@php echo  $data->gateway->acct_name @endphp</h2>
                                ...
                                <h2 style="font-size: 16px">@php echo  $data->gateway->bank_name @endphp</h2>
